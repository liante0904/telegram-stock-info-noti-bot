...
async def reset_and_send(firm_order, date_str, board_order=None, do_send=False):
    ...
    # SQLite/PostgreSQL 호환을 위해 execute_query의 치환 기능 활용
    update_query = "UPDATE data_main_daily_send SET MAIN_CH_SEND_YN = 'N' WHERE SEC_FIRM_ORDER = ? AND DATE(SAVE_TIME) = ?"
    ...
    if do_send:
        ...
        SELECT report_id, SEC_FIRM_ORDER, ARTICLE_BOARD_ORDER, FIRM_NM, REG_DT,
               ...
               DOWNLOAD_URL, WRITER, SAVE_TIME, TELEGRAM_URL, PDF_URL
