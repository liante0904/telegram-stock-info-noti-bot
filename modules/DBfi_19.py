...
async def extract_dbfi_pdf_url(session, encoded_url):
    ...
    gate_url = f"__DBFI_VIEWER_BASE_URL____DBFI_GATE_PATH__?q={gate_q}"
    ...
    try:
        async with session.post("__DBFI_VIEWER_BASE_URL____DBFI_AUTH_PATH__", headers=pv_headers) as auth_response:
        ...
        async with session.post(
            "__DBFI_VIEWER_BASE_URL____DBFI_VIEWER_PATH__",
            headers=pv_headers,
            data=viewer_payload,
        ) as viewer_response:
            ...
            pdf_url = f"__DBFI_VIEWER_BASE_URL____DBFI_DOCUMENT_PATH_TEMPLATE__"
            return {
                "gate_url": gate_url,
                "viewer_url": "__DBFI_VIEWER_BASE_URL____DBFI_VIEWER_PATH__",
                "doc_id": doc_id,
                "file_name": file_name,
                "pdf_url": pdf_url,
            }
