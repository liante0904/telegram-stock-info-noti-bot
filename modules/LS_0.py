...
def LS_checkNewArticle(page=1, is_imported=False, skip_boards=None):
    ...
    TARGET_URL_TUPLE = (
        f'REMOVED&currPage={page}',    #"이슈브리프", 
        f'REMOVED&currPage={page}',     #"기업분석",
        f'REMOVED&currPage={page}',     #"산업분석",   
        f'REMOVED&currPage={page}',     #"투자전략",   
        f'REMOVED&currPage={page}',    #"Quant",      
        f'REMOVED&currPage={page}',     #"Macro",      
        f'REMOVED&currPage={page}',    #"FI/ Credit", 
        f'REMOVED&currPage={page}',    #"Commodity",  
        f'REMOVED&currPage={page}',     #"정기자료", 
        f'REMOVED&currPage={page}'     #"해외리서치"], 
    )
