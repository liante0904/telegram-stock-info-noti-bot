...
async def LS_checkNewArticle():
    ...
    TARGET_URLS = [
        'https://www.ls-sec.co.kr/EtwFrontBoard/List.jsp?board_no=146',
        'https://www.ls-sec.co.kr/EtwFrontBoard/List.jsp?board_no=36',
        'https://www.ls-sec.co.kr/EtwFrontBoard/List.jsp?board_no=37',
        'https://www.ls-sec.co.kr/EtwFrontBoard/List.jsp?board_no=38',
        'https://www.ls-sec.co.kr/EtwFrontBoard/List.jsp?board_no=147',
        'https://www.ls-sec.co.kr/EtwFrontBoard/List.jsp?board_no=39',
        'https://www.ls-sec.co.kr/EtwFrontBoard/List.jsp?board_no=183',
        'https://www.ls-sec.co.kr/EtwFrontBoard/List.jsp?board_no=145'
    ]
