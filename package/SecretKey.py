...
class SecretKey:
     def __init__(self):
        ...
        self.TELEGRAM_CHANNEL_ID_NAVER_FLASHNEWS         = ""
        self.TELEGRAM_CHANNEL_ID_NAVER_RANKNEWS          = ""
        self.TELEGRAM_CHANNEL_ID_ITOOZA                  = ""
        self.TELEGRAM_CHANNEL_ID_CHOSUNBIZBOT            = ""
        self.TELEGRAM_CHANNEL_ID_REPORT_ALARM            = ""
        self.TELEGRAM_CHANNEL_ID_TODAY_REPORT            = ""
        self.TELEGRAM_CHANNEL_ID_HANKYUNG_CONSEN         = ""
        self.TELEGRAM_CHANNEL_ID_TEST                    = ""
        self.TELEGRAM_USER_ID_DEV                        = ""
        self.IS_DEV                                      = ""
